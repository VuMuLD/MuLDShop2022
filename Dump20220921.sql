...
CREATE TABLE `chi_tiet_hoa_don` (
  ...
  CONSTRAINT `ma_chi_tiet_hoa_don` FOREIGN KEY (`ma_chi_tiet_hoa_don`) REFERENCES `san_pham` (`ma_san_pham`)
...
CREATE TABLE `hoa_don` (
  ...
  CONSTRAINT `ma_hoa_don` FOREIGN KEY (`ma_hoa_don`) REFERENCES `tai_khoan` (`ma_tai_khoan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `san_pham` (
  ...
  CONSTRAINT `ma_san_pham` FOREIGN KEY (`ma_san_pham`) REFERENCES `danh_muc` (`ma_danh_muc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-21 16:21:23
